...
"""
OrbitLink Enterprise Gateway - Authentication & Authorization
...
SECRET_KEY = "orbitlink-enterprise-secret-key-change-in-production"  # TODO: Move to env
ALGORITHM = "HS256"
...
USERS_DB: Dict[str, Dict] = {
    "enterprise_admin": {
        ...
        "role": "admin",
        "organization": "OrbitLink Internal",
        "disabled": False,
    },
    "acme_partner": {
...
def generate_api_key(device_id: str, organization: str) -> str:
    ...
    prefix = "ok"  # OrbitLink key prefix
