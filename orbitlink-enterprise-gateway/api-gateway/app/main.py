...
"""
OrbitLink Enterprise Gateway - Main Application
...
async def lifespan(app: FastAPI):
    ...
    """
    print("🚀 Initializing OrbitLink Enterprise Gateway...")
    init_db()
    print("✅ Database initialized")
    print("📡 API Gateway ready for enterprise connectivity")
    yield
    print("👋 Shutting down OrbitLink Enterprise Gateway")
...
app = FastAPI(
    title="OrbitLink Enterprise Gateway",
    description="""
    **Enterprise Network Telemetry & Integration Platform**
    
    OrbitLink provides secure APIs for satellite network integration,
...
async def health_check():
    ...
    **Health Check**
    ...
    return {
        "status": "healthy",
        "service": "OrbitLink Enterprise Gateway",
        "version": "1.0.0",
    }
...
async def root():
    ...
    **API Root**
    ...
    """
    return {
        "message": "Welcome to OrbitLink Enterprise Gateway",
        "version": "1.0.0",
        "documentation": {
            "swagger": "/docs",
            "redoc": "/redoc",
