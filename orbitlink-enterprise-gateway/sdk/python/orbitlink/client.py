# sdk/python/orbitlink/client.py
"""
OrbitLink Enterprise SDK
Python client library for OrbitLink Enterprise Gateway
"""
...
class OrbitLinkClient:
    """
    OrbitLink API Client
    
    Example:
        client = OrbitLinkClient(api_key="your-api-key")
