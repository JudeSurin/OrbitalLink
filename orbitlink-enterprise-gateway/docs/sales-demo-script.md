# OrbitLink - Technical Sales Demo Script
...
"Today I'll show you how OrbitLink solves the satellite connectivity integration challenge..."
...
client = OrbitLinkClient(api_key="...")
